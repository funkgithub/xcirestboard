...
<link rel="stylesheet" href="${app}/webjars/jquery-ui/1.12.1/jquery-ui.css">
<script type="text/javascript" src="${app}/webjars/jquery/3.6.0/jquery.js"></script>
<script type="text/javascript" src="${app}/webjars/jquery-ui/1.12.1/jquery-ui.js"></script>
<script>
...
function displayCommentList(data) {
	var mytable = "<table border='0'><tr><td>";
  	$.each( data, function( key, val ) {
    	mytable += "<table border='0'><tr><td>" + val['com_no'] + "," + val['userDTO']['usr_id'];
    	mytable += "(" + val['userDTO']['usr_name']+ ")" + "</td></tr>";
